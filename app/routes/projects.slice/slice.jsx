...
import expencAppLarge from '~/assets/expenc-large.png';
import expencAppPlaceholder from '~/assets/expenc-placeholder.png';
import expencApp from '~/assets/expenc.png';
...
const title = 'ExpenC';
const description =
  'A modern Android expense management application focused on personal finance tracking and analytics.';
const roles = ['Android Development', 'Local Persistence', 'Analytics'];
    ...
    <Fragment>
      <ProjectContainer className={styles.slice}>
        ...
        <ProjectHeader
          ...
          url="https://github.com/ayush200491/ExpenC-Personal-Expense-Management-Android-Application"
          roles={roles}
        />
        <ProjectSection padding="top">
          <ProjectSectionContent>
            <ProjectImage
              srcSet={`${expencApp} 800w, ${expencAppLarge} 1920w`}
              width={800}
              height={500}
              placeholder={expencAppPlaceholder}
