...
import imageFintracDarkLarge from '~/assets/fintrac-dark-large.png';
import imageFintracDarkPlaceholder from '~/assets/fintrac-dark-placeholder.png';
import imageFintracDark from '~/assets/fintrac-dark.png';
import imageFintracLightLarge from '~/assets/fintrac-light-large.png';
import imageFintracLightPlaceholder from '~/assets/fintrac-light-placeholder.png';
import imageFintracLight from '~/assets/fintrac-light.png';
        ...
        <ProjectSection padding="top">
          <ProjectSectionContent>
            <ProjectImage
              ...
              srcSet={
                isDark
                  ? `${imageFintracDark} 1280w, ${imageFintracDarkLarge} 2560w`
                  : `${imageFintracLight} 1280w, ${imageFintracLightLarge} 2560w`
              }
              width={1280}
              height={800}
              placeholder={
                isDark
                  ? imageFintracDarkPlaceholder
                  : imageFintracLightPlaceholder
              }
