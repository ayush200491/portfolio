...
const title = 'FinTrac';
const description =
  'A full-stack financial management platform with analytics dashboards, authentication, and a responsive modern UI.';
const roles = ['Full Stack Development', 'Backend', 'Frontend'];
    ...
    <Fragment>
      ...
      <ProjectContainer>
        ...
        <ProjectHeader
          ...
          url="https://github.com/ayush200491/FinTrac"
          roles={roles}
        />
        <ProjectSection>
          <ProjectSectionContent>
